...
public class BiebApplication {
	...
	public CommandLineRunner demo(BoekRepository boekRepository, AccountRepository accountRepository,
		...
		return (args) -> {
			Boek b1 = new Boek(0, "9789045353197", "Programmeren met Java voor dummies", "Barry Burd", "Java", "niet beschikbaar", "Java is een van de populairste programmeertalen ter wereld en wordt gebruikt bij het ontwikkelen van websites.", 2);
			...
			Boek b3 = new Boek(0, "9789045354866", "Programmeren met C voor Dummies", "Dan Gookin", "C", "niet beschikbaar", "C is een van de oudste en meest gebruikte programmeertalen. De invloed van C is zo groot dat verschillende andere talen (zoals C++, Java en JavaScript) grotendeels de syntaxis van C gebruiken.", 2);
			...
			Uitlening ul1 = new Uitlening(LocalDate.of(2019, 7, 19), LocalDate.of(2019, 7, 19), b2, ac2, 1);
